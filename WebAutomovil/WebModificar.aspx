<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site1.Master" AutoEventWireup="true" CodeBehind="WebModificar.aspx.cs" Inherits="WebAutomovil.WebModificar" %>
    ...
    <body>
        ...
        <table style="width: 90%; margin:auto;">
            <tr>
                ...
                <td class="cuatro">
                    <asp:TextBox ID="txtAñoSemestre" runat="server" CausesValidation="True"></asp:TextBox>
                </td>
            </tr>
        </table>
        ...
        <table style="width: 90%; margin:auto;">
            <tr>
                ...
                <td class="cuatro">
                    <asp:TextBox ID="txtNroSemestre" runat="server" CausesValidation="True"></asp:TextBox>
                </td>
                <td class="cuatro">TIPO SEMESTRE&nbsp;</td>
                <td class="cuatro">
                    <asp:DropDownList ID="ddlTipoSemestre" runat="server" DataSourceID="sqlTipoSemestre" DataTextField="tipo" DataValueField="idTSem" AppendDataBoundItems="True" CausesValidation="True">
                    </asp:DropDownList>
        ...
        <table style="width: 90%; margin:auto;">
            ...
            <tr>
                ...
                <td class="auto-style1">
                    <asp:DropDownList ID="ddlDocentePEP" runat="server" Height="16px" Width="511px" DataSourceID="sqlDataPEP" DataTextField="nombre" DataValueField="fk_rutDoc">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="sqlDataPEP" runat="server" ConnectionString="Data Source=LAPTOP-R6R278BM;Initial Catalog=DB_M1;Integrated Security=True" SelectCommand="SELECT Docente.nombre, Asignatura.nombre AS Expr1, Seccion.seccion, asig_seccion.fk_rutDoc FROM Asignatura INNER JOIN asig_seccion ON Asignatura.idAsig = asig_seccion.fk_idAsig INNER JOIN Docente ON asig_seccion.fk_rutDoc = Docente.rutDoc INNER JOIN Seccion ON asig_seccion.fk_idSec = Seccion.idSec WHERE (Asignatura.idAsig = 1)" ProviderName="System.Data.SqlClient"></asp:SqlDataSource>
                </td>
        </table>
        ...
        <table style="width: 90%; margin:auto;">
            <tr>
                <td class="uno"></td>
                <td class="auto-style1">
                    <asp:Image ID="imgDiagrama" runat="server" Height="227px" Width="463px" />
                </td
            ...
            <tr>
                <td class="dos" aria-multiline="True">
                    ...
                    <asp:RadioButton ID="rdBeacon" runat="server" Text="Beacons" GroupName="rdTinoo" />
                    <br />
                    <asp:RadioButton ID="rdDron" runat="server" Text="Dron" GroupName="rdTinoo" />
                    <br />
                    <asp:RadioButton ID="rdDomotica" runat="server" Text="Domótica" GroupName="rdTinoo" />
                    <br />
                    <asp:RadioButton ID="rdRobotica" runat="server" Text="Robótica" GroupName="rdTinoo" />
                    <br />
                    <asp:RadioButton ID="rdInternetDeLasCosas" runat="server" Text="Internet de las cosas" GroupName="rdTinoo" />
                    <br />
                    <asp:RadioButton ID="rdLentesVr" runat="server" Text="Lentes VR" GroupName="rdTinoo" />
                  
                    <br />
                  
                    <asp:RadioButton ID="rdOtro" runat="server" Text="Otros" GroupName="rdTinoo" />
                    <br />
                    <asp:TextBox ID="txtOtro" runat="server"></asp:TextBox>
                  
                </td>
                <td class="dos" aria-multiline="True" class="auto-style2">
                    <asp:RadioButton ID="cbWebPay" runat="server" Text="WebPay-Paypal" GroupName="rdTin" />
                    <br />
                    <asp:RadioButton ID="cbMigracion" runat="server" Text="Migración de Datos" GroupName="rdTin" />
                    <br />
                    <asp:RadioButton ID="cbIntegraOtroSis" runat="server" Text="Integración con Otros Sistemas" GroupName="rdTin" />
                    <br />
                </td>
            </tr>
        </table>
                        <table style="width: 90%; margin:auto;">
            <tr>
                <td class="cuatro"><asp:Button class="botones" ID="btnModificar" runat="server" Text="Modificar" Height="33px" Width="257px" OnClick="btnModificar_Click" /></td>
            </tr>
        </table>
    </body>
</asp:Content>
