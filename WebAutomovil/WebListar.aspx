<%@ Page Title="" Language="C#" MasterPageFile="MasterPages/Site1.Master" AutoEventWireup="true" CodeBehind="WebListar.aspx.cs" Inherits="WebAutomovil.WebListarAutomoviles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="folio" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" BorderStyle="Groove" BorderWidth="5px" HorizontalAlign="Center" Width="869px">
